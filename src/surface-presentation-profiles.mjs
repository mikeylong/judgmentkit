...
export const ARTIFACT_INSPECTOR_SURFACE_PROFILE = deepFreeze({
  ...
  authority: {
    ...
    review_result_policy:
      "Report chrome, overlay, external artifact, and boundary results separately; never describe the external artifact as JudgmentKit-conformant, and keep owned scopes review_required until the deferred interactive attestation exists.",
  },
  activation: {
    default_request: "auto",
    accepted_requests: [
  ...
  component_role_authority: "semantic_contract_only",
  component_roles: [
  ...
  evidence_expectations: [
    ...
    "The deferred interactive attestation must provide an exact region and authority map for inspector chrome, inspection overlay, primary artifact, and their boundary.",
    "The deferred interactive attestation must prove style isolation in both directions without restyling the external artifact.",
    "The deferred interactive attestation must provide the artifact render fingerprint before and after every chrome state transition.",
    "The deferred interactive attestation must verify pointer, touch, keyboard, and assistive-technology crossings through declared semantic locus identifiers.",
    "The deferred interactive attestation must verify focus order, focus stability, inspection-mode announcements, and focus return.",
    "The deferred interactive attestation must verify overlay occlusion, target re-anchoring, stale targets, and target-drift prevention.",
    "The deferred interactive attestation must cover wide and narrow rest, selection, preview, invalid, supported, unavailable, recovery, and local-result states.",
    "The deferred interactive attestation must report chrome conformance, overlay conformance, external artifact preservation, and boundary behavior separately.",
  ],
  provenance: {
    definition_id: ARTIFACT_INSPECTOR_SURFACE_PROFILE_ID,
    promotion_status: "proposed",
    runtime_evidence_policy: "deferred_interactive_attestation_required",
    runtime_evidence_producer: "unavailable_in_this_release",
