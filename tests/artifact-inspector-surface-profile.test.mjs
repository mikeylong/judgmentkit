...
assert.equal(
  ARTIFACT_INSPECTOR_SURFACE_PROFILE.component_role_authority,
  "semantic_contract_only",
);
assert.equal(
  ARTIFACT_INSPECTOR_SURFACE_PROFILE.provenance.runtime_evidence_policy,
  "deferred_interactive_attestation_required",
);
assert.equal(
  ARTIFACT_INSPECTOR_SURFACE_PROFILE.provenance.runtime_evidence_producer,
